    ...
    >
      ...
      >
        ...
        <a
          ...
          download
          className="mt-6 inline-block bg-gradient-to-r from-blue-400 to-blue-600 text-white py-2 px-4 md:py-2 md:px-6 rounded-lg shadow-lg transition-transform transform hover:scale-110 hover:shadow-xl active:scale-95"
          target='_blank'
        >
          Download CV
        </a>
